# Scored durakları haritada uygunluk puanına göre renklendirme (Geliştirilmiş versiyon)
...
output_file = os.path.join(folder_path, "scored_stops_map_enhanced.html")
...
# Haritayı kaydet
m.save(output_file)
print(f"Geliştirilmiş skor bazlı harita oluşturuldu: {output_file}") 